...
## アプリの基本情報
QR/バーコードをスキャンするメインの機能に加えて、QRコードを作成するサブ機能を備えたアプリです。

リアルタイムでQR/バーコードをスキャンして利用するシーンにおいては、直感的なUI/UXを意識しています。

過去のスキャン結果を確認するシーンにおいては、目的の情報へのアクセスのしやすさ、検索しやすさを重視しました。

また、QRコードを作成する機能においては、ユーザーがよりスムーズに情報を入力できること、いち早く作成したQRコードを共有できる仕組みとしています。
